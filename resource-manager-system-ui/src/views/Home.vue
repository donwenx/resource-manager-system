...
export default {
  ...
  data() {
    return {
      statistics: [
        {id: 1, title: '下载数量', number: 2000, subtitle: '总下载量', img: DownloadIcon },
        {id: 2, title: '磁盘占用', number: 2000, subtitle: '总占用量', img: DiskIcon },
        {id: 3, title: '用户数量', number: 2000, subtitle: '总用户量', img: UsersIcon },
      ]
    }
  },
};
